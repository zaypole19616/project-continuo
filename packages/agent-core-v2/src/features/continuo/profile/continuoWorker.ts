...
const WORKER_ROLE =
  ...
  '- When you need a decision or information the materials do not contain, ask with AskUserQuestion instead of guessing or ending your turn with a plain-text question. Never invent facts that are not in the materials.\n' +
  '- Before your final message of a task that created or changed files, call ReportWorkspaceResult with the exact relative paths and anything left unresolved. The product verifies the paths and shows them on the board.\n' +
