...
- `apps/continuo`: the Continuo workbench — a folder-level agent UI (navigation, file workspace, agent panel) on top of kap-server's `continuo` routes. See `apps/continuo/AGENTS.md`.
