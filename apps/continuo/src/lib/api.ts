...
export interface ContinuoTodo { todoId: string; text: string; title?: string; reason?: string; fromTaskId?: string; schedule?: TodoSchedule; nextAt?: string; lastRunAt?: string; createdAt: string }
